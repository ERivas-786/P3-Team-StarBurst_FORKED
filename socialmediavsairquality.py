...
print("Printing A Haiku....")
print(f"Fresh spring morning time.
That's the sound of solitude,
the presence of peace.
")

# Load the datasets
socialmediadata = pd.read_csv(
    "./datasets/socialmedia.csv", usecols=["User Follower Count", "DateTime"]
)
airqualitydata = pd.read_csv(
    "./datasets/airquality.csv", usecols=["Date", "CO"], nrows=24
)
...
ax1.plot(
    merged_data["Month"],
    merged_data["User Follower Count"],
